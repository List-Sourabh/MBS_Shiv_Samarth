...
public class FundTransferMenuActivity extends Activity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    String retValStr = "", custid = "", retMess = "", version = "",retval = "", respcode = "", respdesc = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuIcon[] menuItem = new MenuIcon[]{
                new MenuIcon(getString(R.string.lbl_own_account_trans),R.mipmap.arrow),
                new MenuIcon(getString(R.string.lbl_same_bnk_trans),R.mipmap.arrow),
                new MenuIcon(getString(R.string.lbl_other_bank_fund_trans_rtgs),R.mipmap.arrow),
                new MenuIcon(getString(R.string.lbl_imps), R.mipmap.arrow),
        ...
        MenuAdaptor adapter = new MenuAdaptor(this, R.layout.listview_item_row,menuItem);

        listView1 = (ListView) findViewById(R.id.listView1);
        View header = (View) this.getLayoutInflater().inflate(R.layout.fundmenu_listview_header_row, null);
...
/*
    public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong) {
        ...
        switch (pos) {
            ...
            case 1:
                intet = new Intent(getApplicationContext(), OwnAccountTransfer.class);
            ...
            case 2:
                ...
                intet = new Intent(getApplicationContext(), SameBankTransfer.class);
                intet.putExtra("var1", var1);
                intet.putExtra("var3", var3);
                startActivity(intet);
                finish();
            ...
            case 4:
                ...
                intet = new Intent(getApplicationContext(), OtherBankTranIFSC.class);
                intet.putExtra("var1", var1);
                intet.putExtra("var3", var3);
                startActivity(intet);
                finish();
            ...
            case 5:
                ...
                Log.e("MBS Case -2", "........11 QrcodeSendActivity");
                intet = new Intent(getApplicationContext(), QrcodeSendActivity.class);
                intet.putExtra("var1", var1);
                intet.putExtra("var3", var3);
                startActivity(intet);
                finish();
...
*/
    ...
    public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong) {
        ...
        switch (pos) {
            ...
            case 1:
                customstartActivity(FundTransferMenuActivity.this, OwnAccountTransfer.class);
                break;

            case 2:
                Log.e("MBS Case -2", "........11 SameBankTransfer");
                customstartActivity(FundTransferMenuActivity.this, SameBankTransfer.class);
                break;

            case 3:
                Log.e("MBS Case -2", "........11 OtherbanktransferRTGS");
                customstartActivity(FundTransferMenuActivity.this, OtherBankTranRTGS.class);
                break;

            case 4:
                //Change Here by Shubham
                Log.e("MBS Case -2", "........11 QrcodeSendActivity");
                customstartActivity(FundTransferMenuActivity.this, OtherBankTranIFSC.class);
                break;

            case 5:

                Log.e("MBS Case -2", "........11 QrcodeSendActivity");
                customstartActivity(FundTransferMenuActivity.this, QrcodeSendActivity.class);

                break;

            case 6:
                Log.e("MBS Case -2", "........11 QrcodeRcvActivity");
                customstartActivity(FundTransferMenuActivity.this, ShowAccForQrcode.class);

                break;

            case 7:
                Log.e("MBS Case -2", "........11 TransferHistory");
                customstartActivity(FundTransferMenuActivity.this, TransferHistory.class);
    ...
    public void customstartActivity(Context A, Class B) {
        try {
            Log.e("Shubham", "From activity:-" + A + " To activity:-" + B);
            ...
            Log.e("Shubham", "startActivity_: " + e.getMessage());
        }
    }
